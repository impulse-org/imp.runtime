...
// TODO Remove dependencies on JDT/UI components - should be completely language-independent.
...
public class ProblemsLabelDecorator implements ILabelDecorator {
    ...
    private static final int ERRORTICK_WARNING= 0; // JavaElementImageDescriptor.WARNING;

    private static final int ERRORTICK_ERROR= 1; // JavaElementImageDescriptor.ERROR;
