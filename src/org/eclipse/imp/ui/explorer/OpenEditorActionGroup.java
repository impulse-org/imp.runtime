...
public class OpenEditorActionGroup extends ActionGroup {
    ...
    /**
     * Creates a new <code>OpenActionGroup</code>. The group requires that the selection provided by the part's selection provider is of type <code>
    ...
    private void addOpenWithMenu(IMenuManager menu) {
        ...
        if (!(resource instanceof IFile))
            return;
        // Create a menu.
        IMenuManager submenu= new MenuManager(IMPMessages.OpenWithMenu_label);
