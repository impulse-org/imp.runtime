...
public class CUCorrectionProposal extends ChangeCorrectionProposal {
	 ...
	 */
	public CUCorrectionProposal(String name, ICompilationUnit cu,
	 ...
	 *            <code>null</code> if no image is desired.
	 */
	protected CUCorrectionProposal(String name, ICompilationUnit cu,
	...
	public void apply(IDocument document) {
		try {
			// Object unit= getCompilationUnit();
	...
	// private boolean performValidateEdit(Object unit) {
	...
	// ErrorDialog.openError(JavaPlugin.getActiveWorkbenchShell(), label,
	// message, status);
	// return false;
	// }
	// return true;
	...
	// /* (non-Javadoc)
	// * @see
	// org.eclipse.jdt.internal.ui.text.correction.ChangeCorrectionProposal#performChange(org.eclipse.jface.text.IDocument,
	...
	//
	// if (fLinkedProposalModel != null) {
	// if (fLinkedProposalModel.hasLinkedPositions() && part instanceof
	// JavaEditor) {
	// // enter linked mode
	 ...
	 * {@link #CUCorrectionProposal(String, Object, TextChange, int, Image)}.
	 * 
