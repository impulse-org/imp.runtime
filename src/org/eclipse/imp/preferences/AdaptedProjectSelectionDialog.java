...
public class AdaptedProjectSelectionDialog extends SelectionStatusDialog {
//public class ProjectSelectionDialog extends SelectionStatusDialog {
	...
	public AdaptedProjectSelectionDialog(Shell parentShell, Set projectsWithSpecifics) {
		super(parentShell);
		setTitle("Select Project");	//PreferencesMessages.ProjectSelectionDialog_title);  
		setMessage("Select the project for which preferences are to be shown");		//PreferencesMessages.ProjectSelectionDialog_desciption); 
	...
	protected Control createDialogArea(Composite parent) {
		...
		checkbox.setText("Filter projects with no project-specific settings"); 
	...
	private void doSelectionChanged(Object[] objects) {
		if (objects.length != 1) {
			updateStatus(new AdaptedStatusInfo(IStatus.ERROR, "")); //$NON-NLS-1$
			setSelectionResult(null);
		} else {
			updateStatus(new AdaptedStatusInfo()); //$NON-NLS-1$
