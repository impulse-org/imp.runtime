...
public class DetailsDialogForBooleanFields extends ProductInfoDialog {
			...
			ISafariPreferencesService preferencesService)
	{
	     ...
	     * 
	     * Here assumes that if a button has been pushed then it's okay to perform
	     * the associated action.  In other words, there are no checks here as
	     * to whether the action to be performed is allowed or sensible.  We just
	     * go for it.
	     */
	    protected void buttonPressed(int buttonId) {
	        ...
	        case REMOVE_ID:
	        	...
	        	// clear a field that was edited locally but not yet stored.
