...
//            }
    ...
    private void submitTextPresentation(final TextPresentation presentation) {
        Display.getDefault().asyncExec(new Runnable() {
            public void run() {
            	...
            	TextPresentation newPresentation= trimPresentationToTextExtent(presentation, charCount);
        	    ...
        	    try {
        	        ...
        	        logStyleRangeError(presentation, charCount, e);
        	        throw e;
        	    }
            }
        });
    ...
    /**
     * Trims the given presentation as necessary to one whose final range doesn't
     * extend beyond the last character in the source text.
     */
    private TextPresentation trimPresentationToTextExtent(final TextPresentation presentation, int charCount) {
     ...
     */
    private void logStyleRangeError(final TextPresentation presentation, int charCount, IllegalArgumentException e) {
