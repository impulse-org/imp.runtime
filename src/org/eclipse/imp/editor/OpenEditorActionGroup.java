...
public class OpenEditorActionGroup extends ActionGroup {
	...
	public OpenEditorActionGroup(IWorkbenchPartSite site, ISelectionProvider specialSelectionProvider) {
		...
		fOpen.setActionDefinitionId(IEditorActionDefinitionIds.OPEN_EDITOR);
	...
	public OpenEditorActionGroup(UniversalEditor editor) {
		...
		fOpen.setActionDefinitionId(IEditorActionDefinitionIds.OPEN_EDITOR);
		editor.setAction(IEditorActionDefinitionIds.OPEN_EDITOR, fOpen); //$NON-NLS-1$
...
//		}
	...
	private void setGlobalActionHandlers(IActionBars actionBars) {
		actionBars.setGlobalActionHandler(IMPActionConstants.OPEN, fOpen);
	}
