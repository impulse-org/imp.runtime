...
/**
 * Action group that adds the open and show actions to a context menu and the action bar's navigate menu. This action group reuses the <code>
...
public class NavigateActionGroup extends ActionGroup {
    ...
    /**
     * Creates a new <code>NavigateActionGroup</code>. The group requires that the selection provided by the part's selection provider is of type <code>
