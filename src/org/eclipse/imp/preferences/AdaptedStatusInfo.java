 ...
 */
public class AdaptedStatusInfo implements IStatus {
	
	public static final IStatus OK_STATUS= new AdaptedStatusInfo();
	 ...
	 * WARNING and INFO.
	 */	
	public AdaptedStatusInfo(int severity, String message) {
