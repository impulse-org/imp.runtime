...
public interface IContextMenuConstants {
    /**
     * Type hierarchy view part: pop-up menu target ID for type hierarchy viewer (value <code>"org.eclipse.jdt.ui.TypeHierarchy.typehierarchy"</code>).
     * 
     * @since 2.0
     */
    ...
    /**
     * Type hierarchy view part: pop-up menu target ID for supertype hierarchy viewer (value <code>"org.eclipse.jdt.ui.TypeHierarchy.supertypes"</code>).
     * 
     * @since 2.0
     */
    ...
    /**
     * Type hierarchy view part: Pop-up menu target ID for the subtype hierarchy viewer (value <code>"org.eclipse.jdt.ui.TypeHierarchy.subtypes"</code>).
     * 
     * @since 2.0
     */
    ...
    /**
     * Type hierarchy view part: pop-up menu target ID for the member viewer (value <code>"org.eclipse.jdt.ui.TypeHierarchy.members"</code>).
     * 
     * @since 2.0
     */
    ...
    /**
     * Pop-up menu: name of group for source actions. This is an alias for <code>GROUP_GENERATE</code> to be more consistent with main menu bar structure.
     * 
     * @since 2.0
     */
