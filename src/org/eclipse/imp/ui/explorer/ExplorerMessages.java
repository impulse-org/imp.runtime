...
public final class ExplorerMessages extends NLS {
    private static final String BUNDLE_NAME= "org.eclipse.imp.ui.explorer.ExplorerMessages";//$NON-NLS-1$
    ...
    public static String ProjectExplorer_filters;

    public static String ProjectExplorer_gotoTitle;

    public static String ProjectExplorer_openPerspective;

    public static String ProjectExplorer_refactoringTitle;

    public static String ProjectExplorer_referencedLibs;

    public static String ProjectExplorer_binaryProjects;

    public static String ProjectExplorer_title;
    ...
    public static String ProjectExplorer_element_not_present;

    public static String ProjectExplorer_filteredDialog_title;

    public static String ProjectExplorer_notFound;

    public static String ProjectExplorer_removeFilters;
