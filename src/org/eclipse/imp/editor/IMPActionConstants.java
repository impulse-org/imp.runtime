 ...
 * for actions in context menus of IMP views.
 *
 * <p>
...
//	public static final String GOTO_PACKAGE= "org.eclipse.jdt.ui.actions.GoToPackage"; //$NON-NLS-1$
	 ...
	 * (value <code>"org.eclipse.imp.runtime.actions.Open"</code>).
	 */
	public static final String OPEN= RuntimePlugin.IMP_RUNTIME + ".actions.Open"; //$NON-NLS-1$
...
//	public static final String UNCOMMENT= "org.eclipse.jdt.ui.actions.Uncomment"; //$NON-NLS-1$
	 ...
	 * @since 3.0
	 */
	public static final String TOGGLE_COMMENT= RuntimePlugin.IMP_RUNTIME + ".actions.toggleComment"; //$NON-NLS-1$
	 ...
	 * @since 3.0
	 */
	public static final String ADD_BLOCK_COMMENT= RuntimePlugin.IMP_RUNTIME + ".actions.AddBlockComment"; //$NON-NLS-1$
	 ...
	 * @since 3.0
	 */
	public static final String REMOVE_BLOCK_COMMENT= RuntimePlugin.IMP_RUNTIME + ".actions.RemoveBlockComment"; //$NON-NLS-1$

	/**
	 * Source menu: name of standard Correct Indentation global action
	 * (value <code>"org.eclipse.imp.runtime.actions.correctIndentation"</code>).
	 *
	 * @since 3.0
	 */
	public static final String CORRECT_INDENTATION= RuntimePlugin.IMP_RUNTIME + ".actions.correctIndentation"; //$NON-NLS-1$

	/**
	 * Source menu: name of standard Shift Right action
	 * (value <code>"org.eclipse.jdt.ui.actions.ShiftRight"</code>).
	 */
	public static final String SHIFT_RIGHT= RuntimePlugin.IMP_RUNTIME + ".actions.shiftRight"; //$NON-NLS-1$

	/**
	 * Source menu: name of standard Shift Left global action
	 * (value <code>"org.eclipse.jdt.ui.actions.ShiftLeft"</code>).
	 */
	public static final String SHIFT_LEFT= RuntimePlugin.IMP_RUNTIME + ".actions.shiftLeft"; //$NON-NLS-1$

	/**
	 * Source menu: name of standard Format global action
	 * (value <code>"org.eclipse.jdt.ui.actions.Format"</code>).
	 */
	public static final String FORMAT= RuntimePlugin.IMP_RUNTIME + ".actions.format"; //$NON-NLS-1$
